/**
 * <file>Tipos.c</file>
 * <brief>Programa que ejemplifica los diferentes tipos de datos en C</brief>
...
int main(void)
{
	...
	char UnArregloDeCaracteres[15] = {'H', 'o', 'l', 'a', ' ', 'M', 'u', 'n', 'd', 'o'}; 
	char OtroArreglo[15] = "Hello World!"; // No se puede asignar de esta manera a menos que sea en inicialización de variable
	...
	int UnArreglo[5] = {1, 2, 3, 4, 5}; // Un arreglo de memoria, para saber más de arreglos ver los ejercicios de arreglos
